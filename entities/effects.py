...
class Effect:
    ...
    `change_damage_dealt` [int] is supposed to be an amount of bonus damage that the Pawn this effect is applied to can deal while it has this effect. Positive values add bonus damage to a Pawn's attack, negative values decrease the Pawn's damage. The default value is zero.  
...
Fire = Effect(name="Fire", damage=2, remaining_duration=0,
              change_damage_dealt=0, change_movement=0)
